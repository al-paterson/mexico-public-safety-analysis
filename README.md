...
- Incidents **grew 72.3%** from 2015 (32,817) to 2025 (56,559), after peaking at 63,334 in 2023
- **Robo (theft)** is the dominant crime type, accounting for 252,721 incidents from 2015 to 2025
- **October** has the most incidents per day; **January** has the fewest, a moderate 11.6% seasonal gap
...
| `chart2_top_crimes.png` | Top 10 crime types, 2015–2025 |
| `chart3_seasonal.png` | Incidents per day by month, seasonal pattern |
