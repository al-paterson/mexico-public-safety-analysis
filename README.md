...
- Incidents grew from 32,817 in 2015 to 56,559 in 2025 (+72.3%), after peaking at 63,334 in 2023.
- **Robo (theft)** dominates the totals: 252,721 incidents from 2015 to 2025, far ahead of any other category.
- Seasonality exists but is mild: counted per day, October is the highest month and January the lowest, a ~12% gap.
...
- The yearly format is **wide** (one column per month), so I reshaped it into long format (one row per state-category-month-year) to make SQL queries reasonable.
